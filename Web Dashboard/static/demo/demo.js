demo = {
  ...
  initChartPageCharts: function () {
    ...
    var e = document
      .getElementById("barChartMultipleBarsNoGradient")
      .getContext("2d");
    var a = {
      type: "bar",
      data: {
  ...
  initGoogleMaps: function () {
    var myLatlng = new google.maps.LatLng(27.6057, 77.5933);
    var mapOptions = {
      zoom: 13,
      center: myLatlng,
      scrollwheel: false,
  ...
  showNotification: function (from, align) {
    ...
    $.notify(
      ...
      { type: color, timer: 4000, placement: { from: from, align: align } }
    );
  },
};
...
function fetchLatestSOSAlert() {
  $.ajax({
      url: '/api/fetch-sos-alerts/',  // The API endpoint
      method: 'GET',
      ...
      error: function() {
          console.error('Failed to fetch the latest SOS alert');
      }
  });
}

// Poll for the latest SOS alert every 5 seconds
// setInterval(fetchLatestSOSAlert, 2000);  // 5000 milliseconds = 5 seconds
